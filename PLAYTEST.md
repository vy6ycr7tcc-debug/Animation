...
| The temple | Walk through the door of the pylon near the shore (on the map: "The temple"). Inside, the archetypes stand in their shrines: the Mind on the left, the Body on the right, the Spirit in the sanctuary beyond the gateway, the Choice at its centre. Inside you wear a linen robe and don't glow. At the centre of the sanctuary, tap "The cards" by the altar: all 22 archetypes as 3D cards; ‹ › or swipe to turn them, tap a numeral to jump. Walk out through the door you came in by | the same; ← → for the cards, Esc to leave them |
